...
USTRUCT(BlueprintType)
struct FDGameplayEffectContext : public FGameplayEffectContext
{
	GENERATED_BODY()
...
public:
	...
	virtual FDGameplayEffectContext* Duplicate() const
	{
		FDGameplayEffectContext* NewContext = new FDGameplayEffectContext();
		*NewContext = *this;
		if (GetHitResult())
		{
