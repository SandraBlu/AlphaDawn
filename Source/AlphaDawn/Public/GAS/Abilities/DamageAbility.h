 ...
 */
UCLASS()
class ALPHADAWN_API UDamageAbility : public UDGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	FDamageEffectParams MakeDamageEffectParamsFromClassDefaults(AActor* TargetActor = nullptr, FVector InRadialDamageOrigin = FVector::ZeroVector, bool bOverrideKnockbackDirection = false,
		FVector KnockbackOverride = FVector::ZeroVector, bool bOverrideDeathImpulse = false, FVector DeathImpulseOverride = FVector::ZeroVector, bool bOverridePitch = false, float PitchOverride = 0.f) const;
