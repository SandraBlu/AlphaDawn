 ...
 */
UCLASS()
class ALPHADAWN_API UEquipItem : public UItem
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class ALPHADAWN_API UEquipItem_Clothing : public UEquipItem
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class ALPHADAWN_API UEquipItem_Weapon : public UEquipItem
{
	GENERATED_BODY()
