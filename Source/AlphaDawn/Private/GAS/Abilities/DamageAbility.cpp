...
FDamageEffectParams UDamageAbility::MakeDamageEffectParamsFromClassDefaults(AActor* TargetActor, FVector InRadialDamageOrigin, bool bOverrideKnockbackDirection, FVector KnockbackOverride,
...
FTaggedMontage UDamageAbility::GetRandomTaggedMontage(const TArray<FTaggedMontage>& TaggedMontages) const
{
